...
using CIAN_API.Controllers.V1.Bus;
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        //
                        //c.InjectStylesheet(thisAssembly, "CIAN_API.CustomContent.dotnetlatest.css");

                        // Use the "InjectJavaScript" option to invoke one or more custom JavaScripts after the swagger-ui
                        // has loaded. The file must be included in your project as an "Embedded Resource", and then the resource's
                        // "Logical Name" is passed to the method as shown above.
                        //
                        //c.InjectJavaScript(thisAssembly, "CIAN_API.CustomContent.basic-auth.js");
                        ...
                        //
                        //c.CustomAsset("index", thisAssembly, "CIAN_API.CustomContent.index.html");
